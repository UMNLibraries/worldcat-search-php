...
class WorldCatSearchRequestIteratorTest extends UnitTestCase
{
    ...
    {
        $iterator = new WorldCatSearch_Request_Iterator_OCLCIdList(array(
            'wskey' => $this->wskey,
            'oclc_id_list' => array('35007366','37175264','48536081',),
        ));
        $this->assertIsA($iterator, 'WorldCatSearch_Request_Iterator_OCLCIdList');

        $this->verify_counts($iterator, array(1,), array(3,));
